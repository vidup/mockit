...
This is a work in progress and is subject to change completely and breakingly. If you come across this package, I suggest
you don't use it in production yet.

# Philosophy

I'm a big fan of dependency injection as a way to write testable code. The idea behind this library is to provide a simple way to mock injected dependencies in your code.
...
I wanted something that was lightweight and easy to use, potentially out of a test framework context too.
...
Our mocks are generated by passing a class to the `mock` function. This will return an `Mock` instance, camouflaged as the class you passed in.
